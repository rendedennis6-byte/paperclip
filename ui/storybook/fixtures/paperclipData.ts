...
export const storybookBudgetSummaries: BudgetPolicySummary[] = [
  {
    ...
    warnPercent: 80,
    warnHighPercent: 95,
    warnRecoveryPercent: 70,
    warnHighRecoveryPercent: 85,
...
export const storybookDashboardSummary: DashboardSummary = {
  ...
  guardrail: { level: 0, utilizationPercent: 27 },
  costByClass: [
    { costClass: "free", spentCents: 0 },
    { costClass: "metered", spentCents: 67_500 },
    { costClass: "critical", spentCents: 0 },
  ],
  runActivity: [
